...
staff_files = {
    "last_op": "last_ope" # for the future
}
...
def read_file(elem): # also also for the future
...
def intro():
    ...
    print("COP = Coprime checking\nPR+ = Series of prime numbers\nP! = Prime Factorization")
    print("SQRT = Square and square root\nSQ = Square numbers\nCBRT = Cube and cube root\nO = Rounding")
    print("+++ = Artihmetic mean\n~ = Median")
